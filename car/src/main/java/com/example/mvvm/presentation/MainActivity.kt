...
//                при табе запускаем Home()
                R.id.categoriesItemBottomNav -> supportFragmentManager.beginTransaction().replace(R.id.content, Cars()).commit()
...
//        binding?.loader?.let { carsViewModel.migration(this,it)}
//        carsViewModel.migration(this
    }
